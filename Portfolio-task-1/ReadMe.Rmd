...
+----------------------------+---------------------------------------------------------------------------------+
| data-entry.xlsx            | refined dataset with added columns for data entry and validation rules included |
+----------------------------+---------------------------------------------------------------------------------+
| data-entry.csv             | exported file from Excel after data entry completed                             |
+----------------------------+---------------------------------------------------------------------------------+
...
|                      |                                                                                                      |
|                      | Value= 0 if pounds and/or shillings has a value but there are no pence.                              |
|                      |                                                                                                      |
|                      | Value = 'np' if no monetary value present                                                            |
+----------------------+------------------------------------------------------------------------------------------------------+
| BOUNDARY_DESCRIPTION | Transcribed text of the paragraph following the text                                                 |
|                      |                                                                                                      |
|                      | 'bounded as follows (that is to say) on the'                                                         |
|                      |                                                                                                      |
|                      | on the digital image. To be used to accurately locate the land granted on a map.                     |
+----------------------+------------------------------------------------------------------------------------------------------+
