...
Note for the structured reflection were added in Tropy, and the images in the 'structured reflection' list were exported to a .csv file using the Tropy CSV Eport plugin [@exportw]
