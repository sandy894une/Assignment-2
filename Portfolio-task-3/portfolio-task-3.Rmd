...
![Figure 1: Extract from Kempton Streetscape Study 1997](/images/extract-kempton-streetscape-study.png){width="800"}
...
Voyant Tools was used to analyse the four documents listed above. The resulting 'cirrus' diagram is shown in Figure 2 and the 'trends' diagram in Figure 3 indicating the prominent role of 'heritage' in the documents.

![Figure 2: Cirrus Diagram from Voyant Tools](/images/voyant-all-docs.jpg)
![Figure 3: Trends Diagram from Voyant Tools](/images/voyant-trends-all-docs.jpg)